...
public record DailyWeatherItem(string Date, double Temperature, int WeatherCode)
{
    public string Emoji => WeatherCodeExtensions.GetWeatherEmoji(WeatherCode);
    public string Description => WeatherCodeExtensions.GetWeatherDescription(WeatherCode);
}
