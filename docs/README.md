...
| **MauiAIAnnotations.Maui** | Reusable MAUI chat UI — `ChatOverlayControl`, content template system, and human-in-the-loop approval dialogs. |
...
- **Reusable chat sidebar/overlay** — Drop `ChatOverlayControl` into any MAUI page for a ready-made AI chat experience.
